 ...
 * #L%
 */
package gmd.addins.demo.client.application.hero;
...
public class HeroVideoPresenter extends BasePresenter<HeroVideoPresenter.MyView, HeroVideoPresenter.MyProxy> {
    ...
    @ProxyStandard
    @NameToken(NameTokens.HERO_VIDEO)
    interface MyProxy extends ProxyPlace<HeroVideoPresenter> {
    }
