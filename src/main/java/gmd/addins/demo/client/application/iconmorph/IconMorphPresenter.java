...
public class IconMorphPresenter extends BasePresenter<IconMorphPresenter.MyView, IconMorphPresenter.MyProxy> {
    ...
    @ProxyStandard
    @NameToken(NameTokens.ICON_MORPH)
    ...
    protected void onBind() {
        ...
        setHeaderTitle("Icon Morph", "Provides visual continuity by morphing two material icons.", "");
    }
}
