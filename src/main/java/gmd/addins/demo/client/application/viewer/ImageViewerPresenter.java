 ...
 * #L%
 */
package gmd.addins.demo.client.application.viewer;
...
public class ImageViewerPresenter extends BasePresenter<ImageViewerPresenter.MyView, ImageViewerPresenter.MyProxy> {
    ...
    @ProxyStandard
    @NameToken(NameTokens.IMAGE_VIEWER)
    interface MyProxy extends ProxyPlace<ImageViewerPresenter> {
    }
