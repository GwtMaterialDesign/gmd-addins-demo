...
public class AutocompletePresenter extends BasePresenter<AutocompletePresenter.MyView, AutocompletePresenter.MyProxy> {
    ...
    protected void onBind() {
        ...
        setHeaderTitle("Autocomplete", "Autocompletes are best way for selecting item easily and grouped them into chips for later search based on item values.", "");
    }
}
