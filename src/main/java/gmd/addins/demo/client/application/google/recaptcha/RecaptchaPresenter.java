...
public class RecaptchaPresenter extends BasePresenter<RecaptchaPresenter.MyView, RecaptchaPresenter.MyProxy> {
    ...
    interface MyProxy extends ProxyPlace<RecaptchaPresenter> {
    }
