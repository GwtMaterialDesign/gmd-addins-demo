...
public class OverlayPresenter extends BasePresenter<OverlayPresenter.MyView, OverlayPresenter.MyProxy> {
    ...
    protected void onBind() {
        ...
        setHeaderTitle("Overlay", "Provides a meaningful transition of source widget to popup or overlay panel.", "");
    }
}
