...
public class DndPresenter extends BasePresenter<DndPresenter.MyView, DndPresenter.MyProxy> {
    ...
    @ProxyStandard
    @NameToken(NameTokens.DRAG_AND_DROP)
    ...
    protected void onBind() {
        ...
        setHeaderTitle("Drag and Drop", "Provides a delightful dragging capability.", "");
        setExternalLibrary(ExternalLink.DRAG_AND_DROP);
    }
}
