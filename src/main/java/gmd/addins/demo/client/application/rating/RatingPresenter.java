...
public class RatingPresenter extends BasePresenter<RatingPresenter.MyView, RatingPresenter.MyProxy> {
    ...
    protected void onBind() {
        ...
        setHeaderTitle("Rating", "A component used by the 5-star rating system, for example, allowing users to easily express their opinion about a product, review, video and so on.", "");
    }
}
