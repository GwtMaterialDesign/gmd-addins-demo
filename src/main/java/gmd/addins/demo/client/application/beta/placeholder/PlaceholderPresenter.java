 ...
 * #L%
 */
package gmd.addins.demo.client.application.beta.placeholder;
...
public class PlaceholderPresenter extends BasePresenter<PlaceholderPresenter.MyView, PlaceholderPresenter.MyProxy> {
    ...
    @ProxyStandard
    @NameToken(NameTokens.PLACEHOLDER)
    interface MyProxy extends ProxyPlace<PlaceholderPresenter> {
    }
