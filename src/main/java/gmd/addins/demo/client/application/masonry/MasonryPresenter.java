...
public class MasonryPresenter extends BasePresenter<MasonryPresenter.MyView, MasonryPresenter.MyProxy> {
    ...
    protected void onBind() {
        ...
        setHeaderTitle("Masonry", "Masonry works by placing elements in optimal position based on available vertical space, sort of like a mason fitting stones in a wall.", "");
        setExternalLibrary(ExternalLink.MASONRY);
    }
}
