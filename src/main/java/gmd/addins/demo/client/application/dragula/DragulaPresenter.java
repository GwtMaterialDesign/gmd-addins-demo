...
public class DragulaPresenter extends BasePresenter<DragulaPresenter.MyView, DragulaPresenter.MyProxy> {
    ...
    @ProxyStandard
    @NameToken(NameTokens.DRAGULA)
    interface MyProxy extends ProxyPlace<DragulaPresenter> {
    }
